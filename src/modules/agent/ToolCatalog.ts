...
export const TOOL_CATALOG: ToolDefinition[] = [
  ...
  { name: 'click_coordinate', label: 'Klik elemen', description: 'Mengklik target. Parameter `selector` bisa berupa deskripsi natural (misal "tombol login") atau CSS selector.', whenToUse: 'Saat pengguna meminta klik.', category: 'interaction', requiresPage: true },
  { name: 'double_click_coordinate', label: 'Klik ganda', description: 'Mengklik target dua kali. Parameter `selector` bisa berupa deskripsi natural.', whenToUse: 'Saat pengguna meminta double click.', category: 'interaction', requiresPage: true },
  { name: 'type_text', label: 'Mengetik', description: 'Mengisi input. Parameter `selector` bisa berupa deskripsi natural.', whenToUse: 'Saat pengguna meminta pengisian form.', category: 'interaction', requiresPage: true },
  { name: 'type_with_delay', label: 'Mengetik bertahap', description: 'Mengisi input dengan jeda. Parameter `selector` bisa berupa deskripsi natural.', whenToUse: 'Saat input membutuhkan simulasi pengetikan.', category: 'interaction', requiresPage: true },
  ...
  { name: 'query_context_graph', label: 'Query Multi-Tab Graph', description: 'Mencari informasi, membandingkan data, atau mendapatkan ringkasan entitas dari berbagai tab yang terbuka. (Parameter: query)', whenToUse: 'Saat butuh perbandingan harga, atau ditanya tentang tab lain.', category: 'context', requiresPage: false },
  { name: 'list_tabs', label: 'Daftar tab', description: 'Mendapatkan daftar semua tab browser yang terbuka.', whenToUse: 'Saat pengguna ingin melihat atau mencari tab.', category: 'context', requiresPage: false },
